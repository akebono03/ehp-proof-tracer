...
class RuleRelevanceCategory(Enum):
  THEOREM_SPECIFIC = "theorem_specific"
...
class InferenceRuleCatalogEntry:
  ...
  relevance_category: RuleRelevanceCategory = (
