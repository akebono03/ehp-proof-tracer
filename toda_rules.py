...
@dataclass(frozen=True)
class TodaSuspensionZeroStatement:
  map: TodaSuspensionMap
...
@dataclass(frozen=True)
class TodaProp515Pi12_5HopfIsomorphismStatement:
  map: TodaHopfInvariantMap
  image_group: FiniteCyclicGroup
  source_generator: HomotopyElement
  image_generator: Multiple


def toda_prop515_pi12_5_concrete_exactness_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      ...
      "pi_12^5 concrete EHP exactness"
    ),
    description=(
      "Recognize exactly the two "
      "Toda EHP exactness windows "
      "needed for the Proposition 5.15 "
      "calculation of pi_12^5: "
      "pi_11^4-E-pi_12^5-H-pi_12^9 "
      "and "
      "pi_12^5-H-pi_12^9-Delta-pi_10^4. "
      "No general concrete exactness "
      "specialization framework is added."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop515_pi12_5_hopf_isomorphism_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      "Use H injectivity, H-Delta "
      "exactness, "
      "pi_12^9=Z/8{nu_9}, "
      "pi_10^4=Z/8{nu_4 squared}, "
      "and Toda (5.13) "
      "Delta(nu_9)=plus or minus "
      "2 nu_4 squared. "
      "The kernel of this concrete "
      "Delta map is therefore the "
      "order-two subgroup generated "
      "by 4 nu_9. "
      "Exactness identifies Im(H) "
      "with that kernel, while "
      "H injectivity identifies "
      "pi_12^5 with it. "
      "Introduce sigma triple-prime "
      "only as the concrete source "
      "generator satisfying "
      "H(sigma triple-prime)=4 nu_9. "
      "The independently derived "
      "Toda (5.5) relation "
      "4 nu_9=eta_9 cubed supplies "
      "the source-proof normalization. "
      "No generic finite-kernel or "
      "cyclic-map solver is added."
    ),
    premise_patterns=(
      PremisePattern(
        proof_rule=ProofRule.INFERENCE,
...
def toda_prop515_pi12_5_finite_cyclic_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    if (
      lemma513.sigma_triple_prime
      != hopf_isomorphism.source_generator
    ):
      return False

    if (
      lemma513.hopf_image
      != hopf_isomorphism.image_generator
    ):
      return False

    if (
      lemma513.bracket_membership.element
      != lemma513.sigma_triple_prime
    ):
      return False

    if (
      lemma513.bracket_membership.bracket
      != lemma513.bracket
    ):
      return False
    ...
    return (
      ...
      and sigma_triple_prime.source == 12
      and sigma_triple_prime.target == 5
    )
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.15 "
      "pi_12^5 finite cyclic"
    ),
    description=(
      "Combine the independently "
      "derived Hopf isomorphism "
      "pi_12^5 -> <4 nu_9> "
      "with Toda Lemma 5.13, which "
      "identifies the corresponding "
      "element as sigma triple-prime "
      "in the bracket "
      "{nu_5,8 iota_8,nu_8}_3. "
      "Therefore pi_12^5 is cyclic "
      "of order two generated by "
      "sigma triple-prime. "
      "No generic isomorphism transport "
      "or Toda-bracket solver is added."
    ),
    premise_patterns=(
      PremisePattern(
        proof_rule=ProofRule.INFERENCE,
...
@dataclass(frozen=True)
class TodaProp511NuSquaredFiniteDimensionalStatement:
  pi11_5_group_relation: Relation
  pi12_6_group_relation: Relation
  pi13_7_group_relation: Relation
  pi14_8_group_relation: Relation
  higher_six_stem_group_relation: Relation
  higher_range: ScalarGreaterEqualStatement
  literature_statements: tuple[
    LiteratureStatement,
    ...
...
@dataclass(frozen=True)
class TodaProp511FiniteDimensionalStatement:
  pi8_2_group_relation: Relation
  pi9_3_zero: TodaPrimaryGroupZeroStatement
  pi10_4_group_relation: Relation
...
@dataclass(frozen=True)
class TodaLemma512FirstIndeterminacyZeroStatement:
  bracket: TodaBracket
  ordinary_group: HomotopyGroup


def toda_lemma512_first_indeterminacy_zero_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      "For the defined Toda Lemma 5.12 "
      "bracket "
      "{eta_n, nu_(n+1), eta_(n+4)} "
      "with n>=6, derive that its first "
      "indeterminacy term "
      "eta_n composed with "
      "pi_(n+6)(S^(n+1)) is zero. "
      "Toda (3.2) identifies the ordinary "
      "group pi_(n+6)(S^(n+1)) as the "
      "suspension of pi_(n+5)(S^n). "
      "Toda (4.7) reduces the relevant "
      "composition to the Toda pi-group "
      "branch, and the independently "
      "derived Proposition 5.9 "
      "five-stem vanishing makes the "
      "result zero for n>=6. "
      "The rule keeps the ordinary "
      "homotopy group explicit and does "
      "not identify HomotopyGroup with "
      "TodaPrimaryGroup. "
      "No generic subgroup-composition "
      "algebra, symbolic substitution "
      "engine, or suspension-image "
      "normalizer is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
@dataclass(frozen=True)
class TodaLemma512BracketSingletonMod2Statement:
  bracket: TodaBracket
...
def toda_lemma512_bracket_singleton_mod2_inference_rule():
  def is_concrete_nu_squared_relation(
    relation,
    n,
  ):
    if not isinstance(
    ...
    expected_generator = Composition(
      left=nu_n,
  ...
  def guard(
    ...
    if not is_concrete_nu_squared_relation(
      nu_squared_statement.pi12_6_group_relation,
      6,
    ):
      return False

    if not is_concrete_nu_squared_relation(
      nu_squared_statement.pi13_7_group_relation,
      7,
    ):
      return False

    if not is_concrete_nu_squared_relation(
      nu_squared_statement.pi14_8_group_relation,
      8,
    ):
      return False
    ...
    higher_n_plus_three = ScalarSum(
      left=higher_n,
      right=3,
    )

    higher_n_plus_six = ScalarSum(
      left=higher_n,
      right=6,
    )
    ...
    if (
      higher_relation.lhs
      != TodaPrimaryGroup(
        group_dimension=higher_n_plus_six,
        sphere_dimension=higher_n,
      )
    ):
      return False
    ...
    higher_nu_plus_three = HomotopyElement(
      name="ν_(n+3)",
      dimension=higher_n_plus_three,
      source=higher_n_plus_six,
      target=higher_n_plus_three,
      generator=GeneratorSymbol(
        family="ν",
        index=higher_n_plus_three,
      ),
    )
    ...
    if (
      ...
      != Composition(
        left=higher_nu,
        right=higher_nu_plus_three,
      )
    ):
      return False

    return (
      nu_squared_statement.higher_range
      == ScalarGreaterEqualStatement(
        left=higher_n,
        right=9,
      )
  ...
  return InferenceRule(
    name=(
      "Toda Lemma 5.12 "
      "bracket singleton mod two"
    ),
    description=(
      "For the Toda Lemma 5.12 bracket "
      "{eta_n, nu_(n+1), eta_(n+4)}, "
      "the independently derived first "
      "and second indeterminacy terms "
      "are both zero for n>=6. "
      "Therefore the bracket has exactly "
      "one value. "
      "The independently derived "
      "Toda Proposition 5.11 "
      "finite-dimensional result gives "
      "pi_(n+6)^n=Z/2 generated by "
      "nu_n squared for n>=5. "
      "Hence for n>=6 the unique bracket "
      "value is either zero or "
      "nu_n squared. "
      "This theorem-specific statement "
      "does not choose between those two "
      "values. "
      "No generic Toda-bracket coset "
      "algebra, singleton-set expression, "
      "mod-two coefficient solver, or "
      "generic range-union framework "
      "is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
@dataclass(frozen=True)
class TodaLemma512CoefficientStabilityStatement:
  source_bracket: TodaBracket
  target_bracket: TodaBracket
  source_generator: Composition
  target_generator: Composition
  source_group: TodaPrimaryGroup
  target_group: TodaPrimaryGroup
  n_range: ScalarGreaterEqualStatement


def toda_lemma512_coefficient_stability_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    nu_n = source_generator.left
    nu_n_plus_three = source_generator.right
    ...
    if (
      nu_n_plus_three.dimension
      != n_plus_three
    ):
      return False

    if (
      nu_n_plus_three.source
      != n_plus_six
    ):
      return False

    if (
      nu_n_plus_three.target
      != n_plus_three
    ):
      return False

    if (
      nu_n_plus_three.generator
      != GeneratorSymbol(
        family="ν",
        index=n_plus_three,
      )
  ...
  def build_conclusion(
    ...
    return (
      TodaLemma512CoefficientStabilityStatement(
        ...
        source_generator=singleton.generator,
        target_generator=target_generator,
        source_group=singleton.ambient_group,
        target_group=TodaPrimaryGroup(
  ...
  return InferenceRule(
    ...
    description=(
      "For the Toda Lemma 5.12 singleton "
      "bracket at symbolic n>=6, "
      "write its unique value as either "
      "zero or nu_n squared. "
      "Toda Proposition 1.3 suspends the "
      "bracket into the corresponding "
      "bracket one dimension higher, "
      "and Toda equation (1.15) removes "
      "the indexed-bracket presentation "
      "needed in that suspension step. "
      "The nu-family definition gives the "
      "specific suspension consequence "
      "E(nu_n squared)=nu_(n+1) squared. "
      "Because the ambient six-stem groups "
      "have order two, the minus sign in "
      "Toda Proposition 1.3 is immaterial. "
      "Therefore the zero/nonzero choice "
      "for the singleton bracket is the "
      "same at n and n+1. "
      "Equivalently, if the unique value "
      "is x_n nu_n squared with "
      "x_n in {0,1}, then "
      "x_n=x_(n+1). "
      "No explicit coefficient symbol, "
      "generic bracket-suspension engine, "
      "generic suspension-of-composition "
      "normalizer, generic sign solver, "
      "or generic symbolic-index shift "
      "framework is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
@dataclass(frozen=True)
class TodaLemma512Statement:
  bracket: TodaBracket
  generator: Composition
  n_range: ScalarGreaterEqualStatement


def toda_lemma512_final_integration_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    if (
      stability.target_generator
      != expected_target_generator
    ):
      return False

    if (
      stability.target_group
      != TodaPrimaryGroup(
        group_dimension=n_plus_seven,
        sphere_dimension=n_plus_one,
      )
    ...
    expected_anchor_bracket = TodaBracket(
      first=eta_8,
      second=nu_9,
      third=eta_12,
    )
    ...
    expected_anchor_generator = Composition(
      left=nu_8,
      right=nu_11,
    )
  ...
  def build_conclusion(
    ...
    return (
      TodaLemma512Statement(
        ...
        generator=singleton.generator,
        n_range=singleton.n_range,
      )
    )
  ...
  return InferenceRule(
    ...
    description=(
      "Phase 74-5 shows that for every "
      "symbolic n>=6, the bracket "
      "{eta_n, nu_(n+1), eta_(n+4)} "
      "is a singleton whose unique value "
      "is either zero or nu_n squared. "
      "Phase 74-6 shows that this "
      "zero/nonzero coefficient is "
      "independent of n: "
      "x_n=x_(n+1) for every n>=6. "
      "Phase 74-7 independently proves "
      "the concrete n=8 anchor "
      "{eta_8, nu_9, eta_12}="
      "{nu_8 squared}, so x_8=1. "
      "Coefficient stability propagates "
      "this value backward to n=7 and n=6 "
      "and forward to every n>=9. "
      "Therefore x_n=1 for every n>=6, "
      "and hence "
      "{eta_n, nu_(n+1), eta_(n+4)}="
      "{nu_n squared} for every n>=6. "
      "No explicit coefficient object, "
      "generic induction engine, "
      "generic integer-range propagation, "
      "generic Toda-bracket set algebra, "
      "or generic theorem specialization "
      "framework is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_nu_squared_finite_dimensional_literature_statements():
  toda_reference = {
    "author": "H. Toda",
    "title": (
      "Composition Methods in "
  ...
  return (
    LiteratureStatement(
      reference=LiteratureReference(
        label="Toda Proposition 5.11",
        locator="Proposition 5.11",
        **toda_reference,
      ),
      statement=(
        "For n at least 5, "
        "pi_(n+6)^n is cyclic of order 2 "
        "generated by nu_n squared, "
        "where nu_n squared is represented "
        "by nu_n composed with nu_(n+3)."
      ),
    ),
  )
...
def toda_prop511_pi8_2_suspension_zero_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    eta_6 = eta6_squared.left
    eta_7 = eta6_squared.right
  ...
  def build_conclusion(
    ...
    return TodaSuspensionZeroStatement(
      map=TodaSuspensionMap(
        source_group=TodaPrimaryGroup(
          group_dimension=8,
          sphere_dimension=2,
  ...
  return InferenceRule(
    ...
    description=(
      "Use the derived group "
      "pi_8^2=Z/2 generated by "
      "eta_2 nu-prime eta_6 squared "
      "and the derived Lemma 5.7 "
      "relation E(eta_2 nu-prime)=0 "
      "to conclude that the concrete "
      "suspension map "
      "E:pi_8^2 -> pi_9^3 is zero. "
      "This is a Proposition 5.11 "
      "specific consequence and does "
      "not introduce a generic "
...
def toda_prop511_pi7_2_suspension_zero_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      "Use Toda Proposition 5.9 "
      "pi_7^2=Z/2 generated by "
      "eta_2 nu-prime eta_6 and the "
      "derived Lemma 5.7 relation "
      "E(eta_2 nu-prime)=0 to "
      "conclude that the concrete "
      "suspension map "
      "E:pi_7^2 -> pi_8^3 is zero. "
...
def toda_prop511_pi9_3_concrete_exactness_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      ...
      "segments used in the proof of "
      "pi_9^3=0: "
      "pi_8^2-E-pi_9^3-H-pi_9^5, "
      "pi_9^3-H-pi_9^5-Delta-pi_7^2, "
      "and "
      "pi_9^5-Delta-pi_7^2-E-pi_8^3. "
      "The existing general symbolic "
      "Proposition 4.2 rules are not "
      "changed."
    ),
    premise_patterns=(
...
def toda_prop511_pi10_7_nu7_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_10^7 nu_7 specialization"
    ),
    description=(
      "Specialize the independently "
      "derived higher branch of Toda "
      "Proposition 5.6, "
      "pi_(n+3)^n=Z/8 generated by nu_n "
      "for n>=6, to n=7. "
      "This gives "
      "pi_10^7=Z/8 generated by nu_7. "
      "No generic symbolic substitution "
      "framework is introduced."
    ),
    premise_patterns=(
...
def toda_prop511_pi10_4_nu4_squared_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    expected_source = DirectSumGroup(
      summands=(
        TodaPrimaryGroup(
          group_dimension=ScalarSum(
            left=i,
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_10^4 generated by nu_4 squared"
    ),
    description=(
      "Use the independently derived "
      "pi_9^3=0 result, the concrete "
      "Proposition 5.6 specialization "
      "pi_10^7=Z/8 generated by nu_7, "
      "and Toda equation (5.6), "
      "pi_(i-1)^3 plus pi_i^7 "
      "isomorphic to pi_i^4 by "
      "(alpha,beta) mapped to "
      "E alpha plus nu_4 composed "
      "with beta. "
      "At i=10 the first summand "
      "vanishes, so the generator "
      "nu_7 maps to "
      "nu_4 composed with nu_7, "
      "which is nu_4 squared. "
      "No generic direct-sum "
      "simplifier or isomorphism "
      "transport framework is added."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_513_delta_nu9_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    expected_delta_iota9_value = Sum(
      left=Multiple(
        coefficient=2,
        expression=nu_4,
      ),
    ...
    if (
      delta_iota9.positive_value
      != expected_delta_iota9_value
    ):
      return False
  ...
  return InferenceRule(
    ...
    description=(
      "For the concrete first relation "
      "of Toda Equation (5.13), use "
      "Toda Equation (5.8), "
      "Delta(iota_9)=plus or minus "
      "(2 nu_4-E nu-prime), "
      "the independently derived "
      "pi_9^3=0 result, and "
      "pi_10^4=Z/8 generated by "
      "nu_4 composed with nu_7. "
      "Proposition 2.5 gives "
      "Delta(nu_9) by right composition "
      "of Delta(iota_9) with nu_7. "
      "The second term is "
      "E(nu-prime composed with nu_6), "
      "and nu-prime composed with nu_6 "
      "lies in the zero group pi_9^3. "
      "Therefore "
      "Delta(nu_9)=plus or minus "
      "2(nu_4 composed with nu_7). "
      "No generic Proposition 2.5 "
      "composition engine, sign algebra, "
      "or distributivity framework "
      "is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_pi12_9_nu9_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_12^9 nu_9 specialization"
    ),
    description=(
      "Specialize the independently "
      "derived Toda Proposition 5.6 "
      "higher nu-family branch "
      "pi_(n+3)^n=Z/8{nu_n}, n>=6, "
      "at n=9. "
      "This gives "
      "pi_12^9=Z/8{nu_9}. "
      "No generic scalar specialization "
      "framework is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_pi11_5_concrete_exactness_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_11^5 concrete exactness"
    ),
    description=(
      "Recognize only the three concrete "
      "EHP exact sequence windows needed "
      "for the n=4 EHP branch of "
      "Toda Proposition 5.11: "
      "pi_12^9 -> pi_10^4 -> pi_11^5, "
      "pi_10^4 -> pi_11^5 -> pi_11^9, "
      "and pi_11^5 -> pi_11^9 -> pi_9^4. "
      "No generic concrete EHP "
      "specialization framework is added."
    ),
    premise_patterns=(
...
def toda_prop511_pi11_5_hopf_zero_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      "Use Toda Equation (5.12) for n=4: "
      "Delta:pi_11^9 to pi_9^4 "
      "is injective. "
      "Exactness of "
      "pi_11^5 -> pi_11^9 -> pi_9^4 "
      "then gives Im(H)=Ker(Delta)=0, "
      "so the Hopf map is zero."
    ),
    premise_patterns=(
      PremisePattern(
        proof_rule=ProofRule.INFERENCE,
...
def toda_prop511_pi11_5_suspension_surjective_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_11^5 suspension surjective"
    ),
    description=(
      "In the concrete E-H exactness "
      "window for pi_11^5, the Hopf map "
      "is zero. Hence Ker(H) is the whole "
      "group pi_11^5. Exactness gives "
      "Im(E)=Ker(H), so "
      "E:pi_10^4 to pi_11^5 "
      "is surjective."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_pi11_5_nu5_squared_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_11^5 nu_5 squared"
    ),
    description=(
      "Use pi_12^9=Z/8{nu_9}, "
      "pi_10^4=Z/8{nu_4 squared}, "
      "Delta(nu_9)=plus or minus "
      "2 nu_4 squared, concrete Delta-E "
      "exactness, and surjectivity of E. "
      "Since nu_9 generates pi_12^9, "
      "the image of Delta is the subgroup "
      "generated by 2 nu_4 squared. "
      "Thus Ker(E) is that order-four "
      "subgroup of Z/8{nu_4 squared}. "
      "The surjective quotient therefore "
      "has order two and is generated by "
      "E(nu_4 squared)=nu_5 squared. "
      "Hence pi_11^5=Z/2{nu_5 squared}. "
      "This is a concrete Proposition "
      "5.11 calculation; no generic "
      "quotient solver or suspension-"
      "composition normalizer is added."
    ),
    premise_patterns=(
      PremisePattern(
        proof_rule=ProofRule.INFERENCE,
...
def toda_prop511_pi14_13_eta13_inference_rule():
  def guard(
    premises,
    bindings,
  ):
...
def toda_prop511_pi13_7_concrete_exactness_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_13^7 concrete exactness"
    ),
    description=(
      "Recognize only the three concrete "
      "EHP exactness windows needed for "
      "the n=6 EHP branch of "
      "Toda Proposition 5.11."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_pi13_7_suspension_injective_inference_rule():
  def is_eta13(
    expression,
  ):
    if not isinstance(
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_13^7 suspension injective"
    ),
    description=(
      "The source pi_14^13 is cyclic "
      "of order two generated by eta_13. "
      "The independently derived relation "
      "Delta(eta_13)=0 therefore makes "
      "the entire Delta map zero. "
      "Delta-E exactness gives "
      "Ker(E)=Im(Delta)=0, hence "
      "E:pi_12^6 to pi_13^7 "
      "is injective. "
      "The two eta_13 expressions are "
      "matched by mathematical generator "
      "data rather than Python structural "
      "identity."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_pi13_7_hopf_zero_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      "Use Toda Equation (5.12), n=6: "
      "Delta:pi_13^13 to pi_11^6 "
      "is injective. "
      "H-Delta exactness gives "
      "Im(H)=Ker(Delta)=0, "
      "so the Hopf map is zero."
...
def toda_prop511_pi13_7_suspension_surjective_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_13^7 suspension surjective"
    ),
    description=(
      "The Hopf map from pi_13^7 "
      "is zero. "
      "E-H exactness therefore gives "
      "Im(E)=Ker(H)=pi_13^7, "
      "so E:pi_12^6 to pi_13^7 "
      "is surjective."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_pi13_7_suspension_isomorphism_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "pi_13^7 suspension isomorphism"
    ),
    description=(
...
def toda_prop511_pi13_7_nu7_squared_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      ...
      "E:pi_12^6 to pi_13^7. "
      "Suspension transports "
      "nu_6 squared to nu_7 squared. "
      "Therefore "
...
def toda_prop511_nu_squared_finite_dimensional_integration_inference_rule():
  def is_concrete_nu_squared_group_relation(
    relation,
    n,
  ):
    if not isinstance(
  ...
  def guard(
    ...
    if not is_concrete_nu_squared_group_relation(
      pi11_5_relation,
      5,
    ):
      return False
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "nu-squared finite-dimensional "
      "integration"
    ),
    description=(
      "Integrate the independently "
      "derived nu-squared branches "
      "pi_11^5=Z/2{nu_5 squared}, "
      "pi_12^6=Z/2{nu_6 squared}, "
      "pi_13^7=Z/2{nu_7 squared}, "
      "pi_14^8=Z/2{nu_8 squared}, "
      "and the Toda (4.5) higher branch "
      "pi_(n+6)^n=Z/2{nu_n squared} "
      "for n at least 9. "
      "Together these branches give "
      "the finite-dimensional "
      "Proposition 5.11 conclusion "
      "pi_(n+6)^n=Z/2{nu_n squared} "
      "for n at least 5. "
      "The aggregate records already "
      "derived mathematical conclusions "
      "and introduces no new group "
      "calculation, symbolic range solver, "
      "suspension normalizer, or stable "
      "homotopy statement."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_zero_suspension_left_implies_hopf_injective_inference_rule():
  def guard(
    ...
    expected_suspension = (
      TodaSuspensionMap(
        source_group=(
          expected_window.source_term
        ),
        target_group=(
          expected_window.middle_term
        ),
      )
    )
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "zero E implies H injective"
    ),
    description=(
      "For the concrete exact E-H "
      "segment "
      "pi_8^2 -> pi_9^3 -> pi_9^5, "
      "if the left suspension map is "
      "zero, then its image is zero, "
      "so exactness gives zero kernel "
      "for H and therefore H is "
      "injective."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_zero_suspension_right_implies_delta_surjective_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    name=(
      "Toda Proposition 5.11 "
      "zero E implies Delta surjective"
    ),
    description=(
      "For the concrete exact Delta-E "
      "segment "
      "pi_9^5 -> pi_7^2 -> pi_8^3, "
      "if the right suspension map is "
      "zero, then its kernel is all of "
      "pi_7^2. Exactness therefore "
      "makes Delta surjective."
    ),
    premise_patterns=(
      PremisePattern(
        proof_rule=ProofRule.INFERENCE,
...
def toda_prop511_pi9_5_to_pi7_2_delta_injective_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      "For the specific Delta map "
      "from pi_9^5 to pi_7^2, use "
      "surjectivity together with "
      "Toda Proposition 5.8 and "
      "Proposition 5.9 identifying "
      "both source and target as "
      "cyclic groups of order 2. "
      "A surjection between these "
      "two concrete order-two groups "
      "is injective. "
      "No generic finite-cyclic "
      "homomorphism solver is added."
    ),
...
def toda_prop511_pi9_3_zero_inference_rule():
  def guard(
    premises,
    bindings,
  ):
  ...
  return InferenceRule(
    ...
    description=(
      ...
      "and injectivity of Delta. "
      "Delta injectivity gives "
      "kernel Delta=0, so exactness "
      "gives image H=0. Since H is "
      "injective, its source pi_9^3 "
      "must be zero."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_prop511_finite_dimensional_literature_statements():
  toda_reference = {
    "author": "H. Toda",
    "title": (
      "Composition Methods in "
  ...
  return (
    LiteratureStatement(
      ...
      statement=(
        "Finite-dimensional part: "
        "pi_8^2 is cyclic of order 2 "
        "generated by eta_2 composed with "
        "nu-prime composed with eta_6 squared; "
        "pi_9^3 is zero; "
        "pi_10^4 is cyclic of order 8 "
        "generated by nu_4 squared; "
        "and pi_(n+6)^n is cyclic of order 2 "
        "generated by nu_n squared "
        "for n at least 5. "
...
def toda_prop511_finite_dimensional_integration_inference_rule():
  def guard(
    premises,
    bindings,
  ):
    ...
    eta_2 = (
      pi8_2_generator.left
    )

    nu_prime_eta6_squared = (
      pi8_2_generator.right
    )
  ...
  return InferenceRule(
    ...
    description=(
      "Integrate the independently "
      "derived finite-dimensional "
      "Proposition 5.11 conclusions: "
      "pi_8^2=Z/2 generated by "
      "eta_2 nu-prime eta_6 squared, "
      "pi_9^3=0, "
      "pi_10^4=Z/8 generated by "
      "nu_4 squared, and the "
      "nu-squared six-stem result "
      "pi_(n+6)^n=Z/2{nu_n squared} "
      "for n at least 5. "
      "All mathematical branches must "
      "already be derived by inference. "
      "The stable conclusion "
      "(G_6;2)=Z/2{nu squared} "
      "is intentionally excluded. "
      "No stable homotopy-group model "
      "or generic aggregation framework "
      "is introduced."
    ),
    premise_patterns=(
      PremisePattern(
...
def toda_lemma513_sigma_triple_prime_definition_inference_rule():
  def guard(
    ...
    expected_map = TodaHopfInvariantMap(
      source_group=TodaPrimaryGroup(
        group_dimension=12,
        sphere_dimension=5,
      ),
  ...
  def build_conclusion(
    ...
    membership = (
      TodaBracketMembershipStatement(
        element=sigma_triple_prime,
        bracket=bracket,
        source="Toda Lemma 5.13",
        note=(
          "Toda Lemma 5.13 defines "
          "sigma triple-prime by the "
          "indexed bracket "
          "{nu_5,8 iota_8,nu_8}_3."
        ),
      )
  ...
  return InferenceRule(
    ...
    description=(
      "Attach the Toda Lemma 5.13 "
      "bracket provenance to the "
      "concrete element whose Hopf image "
      "has independently been derived "
      "to be 4 nu_9. "
      "The element is recorded as "
      "sigma triple-prime in the indexed "
      "Toda bracket "
      "{nu_5,8 iota_8,nu_8}_3. "
      "This refinement does not add "
      "generic Toda-bracket "
      "indeterminacy algebra."
    ),
    premise_patterns=(
      PremisePattern(
        proof_rule=ProofRule.INFERENCE,
