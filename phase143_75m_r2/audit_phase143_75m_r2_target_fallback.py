...
def main():
    ...
    for k in range(0, 8):
      ...
      try:
        ...
        for node in presentation.nodes:
          ...
          if rule_name is not None and rendered == rule_name:
            fallback[name] += 1
  ...
  print("=" * 78)
  print("Phase 143-75M R2 target fallback audit")
  print("=" * 78)
  ...
  print("total occurrences:", sum(occurrences.values()))
  print("total target fallback:", sum(fallback.values()))
