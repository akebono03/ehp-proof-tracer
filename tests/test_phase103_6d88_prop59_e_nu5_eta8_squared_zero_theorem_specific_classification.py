...
PHASE103_6D88_TARGET_FAMILY = (
  "Toda Proposition 5.9 E nu_5 eta_8 squared zero"
)

PHASE103_6D88_TARGET_FACTORY = (
...
def test_phase103_6d88_classifies_prop59_e_nu5_eta8_squared_zero_as_theorem_specific():
  catalog = _build_catalog()
  families = _families(
    catalog
  )

  assert PHASE103_6D88_TARGET_FAMILY in families
...
def test_phase103_6d88_target_factory_is_exactly_the_audited_singleton():
  catalog = _build_catalog()
...
def test_phase103_6d88_changes_only_target_factory_entry():
  before = (
    _phase103_6d88_original_builder()
  )
  after = (
...
def test_phase103_6d88_target_cluster_is_closed():
  catalog = _build_catalog()
...
def test_phase103_6d88_family_coverage_changes_by_exactly_one_family():
  before = (
    _phase103_6d88_original_builder()
  )
  after = (
...
def test_phase103_6d88_entry_coverage_delta_matches_single_target_entry():
  before = (
    _phase103_6d88_original_builder()
  )
  after = (
...
def test_phase103_6d88_preserves_6d85_e_nu4_eta7_squared_bridge_closure():
  catalog = _build_catalog()
...
def test_phase103_6d88_preserves_structural_and_map_property_counts():
  catalog = _build_catalog()
...
def test_phase103_6d88_catalog_size_and_fixed_point_safety_are_unchanged():
  catalog = _build_catalog()
  entries = tuple(
    catalog.entries()
  )
