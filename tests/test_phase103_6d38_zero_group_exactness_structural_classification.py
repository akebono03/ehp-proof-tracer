...
def test_phase103_6d38_classifies_only_the_two_audited_zero_group_families_as_structural():
...
def test_phase103_6d38_changes_exactly_two_entries_from_6d35_boundary():
  before = (
    _phase103_6d38_original_builder()
  )
  ...
  for key, before_entry in (
    ...
    if (
      ...
      in PHASE103_6D38_TARGET_FAMILIES
    ):
      assert (
...
def test_phase103_6d38_target_zero_group_cluster_is_closed():
  catalog = _build_catalog()
...
def test_phase103_6d38_family_coverage_counts():
  catalog = _build_catalog()
  ...
  assert classified == 112
  assert unclassified == 155


def test_phase103_6d38_entry_coverage_counts():
  catalog = _build_catalog()
...
def test_phase103_6d38_preserves_delta_injectivity_closure():
  catalog = _build_catalog()
...
def test_phase103_6d38_preserves_6d35_suspension_injectivity_closure():
  catalog = _build_catalog()
...
def test_phase103_6d38_catalog_size_and_fixed_point_safety_are_unchanged():
  catalog = _build_catalog()
