...
PHASE103_6D98_TARGET_FACTORY = (
  "toda_53_eta3_twice_zero_inference_rule"
)

PHASE103_6D98_TARGET_FAMILY = (
...
def test_phase103_6d98_classifies_toda53_eta3_twice_zero_as_theorem_specific():
...
def test_phase103_6d98_target_factory_is_exactly_the_audited_factory():
  catalog = _build_catalog()
...
def test_phase103_6d98_changes_only_target_factory():
  before = (
    _phase103_6d98_original_builder()
  )
...
def test_phase103_6d98_target_cluster_is_closed():
  catalog = _build_catalog()
  ...
  residual = tuple(
    ...
    if (
      entry.relevance_category
      is RuleRelevanceCategory.UNCLASSIFIED
      and entry.conclusion_type.__name__
      == "Relation"
      and len(
...
def test_phase103_6d98_family_coverage_changes_by_exactly_one_family():
  before = (
    _phase103_6d98_original_builder()
  )
...
def test_phase103_6d98_entry_coverage_delta_matches_fourteen_target_entries():
  before = (
    _phase103_6d98_original_builder()
  )
...
def test_phase103_6d98_preserves_other_category_counts():
  catalog = _build_catalog()
...
def test_phase103_6d98_catalog_size_and_fixed_point_safety_are_unchanged():
  catalog = _build_catalog()
