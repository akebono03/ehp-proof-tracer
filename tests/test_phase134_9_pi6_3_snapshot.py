...
\[
\pi_{5}^{3} = \mathbb{Z}/2\{\eta_{3}\eta_{4}\}\tag{1}
\]

(1), [R1] より,

\[
\pi_{5}^{2} = \mathbb{Z}/2\{\eta_{2}\eta_{3}\eta_{4}\}\tag{2}
\]


\[
\Delta: \pi_{7}^{5} \to \pi_{5}^{2}\tag{3}
\]
...
\[
\pi_{7}^{5} \xrightarrow{\Delta} \pi_{5}^{2} \xrightarrow{E} \pi_{6}^{3}\tag{4}
\]
...
\[
E: \pi_{5}^{2} \to \pi_{6}^{3}\tag{5}
\]

は単射である.

(2), (5) より,
**(6)** $\eta_{3}\eta_{4}\eta_{5}$ の位数は $2$ である.


\[
2\nu' = \eta_{3}\eta_{4}\eta_{5}\tag{7}
\]
...
\[
\pi_{5}^{2} \xrightarrow{E} \pi_{6}^{3} \xrightarrow{H} \pi_{6}^{5}\tag{12}
\]
