...
from standard_production_applicability_catalog import (
  ...
  _phase103_6d101_apply_theorem_specific_classification,
  _phase103_6d101_original_builder,
)


PHASE103_6D101_TARGET_FACTORY = (
  "toda_lemma54_nu4_membership_inference_rule"
)

PHASE103_6D101_TARGET_FAMILY = (
  "Toda Lemma 5.4 nu_4 membership"
)
...
def test_phase103_6d101_classifies_toda_lemma54_nu4_membership_as_theorem_specific():
...
def test_phase103_6d101_target_factory_is_exactly_the_audited_factory():
  catalog = _build_catalog()
...
def test_phase103_6d101_changes_only_target_factory():
  before = (
    _phase103_6d101_original_builder()
  )
...
def test_phase103_6d101_target_cluster_is_closed():
  catalog = _build_catalog()
...
def test_phase103_6d101_family_coverage_changes_by_exactly_one_family():
  before = (
    _phase103_6d101_original_builder()
  )
...
def test_phase103_6d101_entry_coverage_delta_matches_seven_target_entries():
  before = (
    _phase103_6d101_original_builder()
  )
...
def test_phase103_6d101_preserves_other_category_counts():
  catalog = _build_catalog()
...
def test_phase103_6d101_catalog_size_and_fixed_point_safety_are_unchanged():
  catalog = _build_catalog()
