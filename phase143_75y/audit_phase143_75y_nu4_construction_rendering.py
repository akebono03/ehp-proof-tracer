...
def main():
  ...
  print("target occurrences:", target_occurrences)
  print(
  ...
  print("-" * 78)
  for value, count in outputs.most_common():
    print(
      str(count)
      + " x "
      + value
  ...
  if (
    ...
    and target_semantic_renderings == 37
    and target_rule_name_fallbacks == 0
    and all_rule_name_fallbacks == 288
    and len(fallback_statement_types) == 29
    and not errors
  ):
    print(
      "PASS: all 37 "
      "TodaLemma54Nu4ConstructionStatement "
      "fallbacks were replaced by piecewise "
      "semantic rendering; 288 remain across "
      "29 statement types."
    )
  else:
    print(
