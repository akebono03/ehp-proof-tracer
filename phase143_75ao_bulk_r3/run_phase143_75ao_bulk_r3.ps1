...
try {
  python ".\phase143_75ao_bulk_r3\apply_phase143_75ao_bulk_r3.py"
  ...
  pytest -q `
    ...
    ".\phase143_75ao_bulk_r3\test_phase143_75ao_bulk_r3.py"
  if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

  Write-Host ""
  Write-Host "Phase 143-75AO bulk R3 focused checks passed."
  Write-Host "Old broken patcher was not executed."
