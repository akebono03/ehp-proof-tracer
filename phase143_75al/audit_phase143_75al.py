...
def main():
  ...
  print(
    "Phase 143-75AL "
    "Toda514FirstShortExactStatement semantic structure audit"
  )
  print("=" * 78)
  ...
  print(
    "  source pi_12^5 --E--> "
    "middle pi_13^6 --H--> target pi_13^11"
  )
  print("")
  print(
    "Audit whether the statement carries only the "
    "three groups and two maps, or any explicit "
    "zero-endpoint / short-exactness semantic field."
  )
  print("")
