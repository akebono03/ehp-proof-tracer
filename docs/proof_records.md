...
Phase 95 completion record を含む。
...
`NOT_FOUND / FOUND / MULTIPLE_RESULTS` semantics、candidate identity/order、direct / aggregate provenance preservation、代表6 target の top-level validation、repository non-mutation を含む。
