...
def main():
  ...
  print("=" * 78)
  print(
    "Phase 143-75C target fallback audit"
  )
  print(
  ...
  for target_type in TARGET_TYPES:
    ...
    print(
      f"{name}: "
      f"{target_occurrences[name]} occurrences, "
      f"{target_fallbacks[name]} "
  ...
  if (
    not errors
    and sum(
      target_fallbacks.values()
    ) == 0
  ):
    print(
      "PASS: all three Phase 143-75C "
