...
from toda_group_proof_narrative_arguments import extract_toda_group_proof_narrative_argument_purpose_subject
...
for n, k in ((3, 3), (5, 3), (8, 7), (9, 7)):
  ...
  for index, argument in enumerate(_arguments(n, k), start=1):
    ...
    print(f"A{index:02d} {argument.role.value}: {subject!r}")
