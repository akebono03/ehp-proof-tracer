...
EXPECTED_FALLBACK_OCCURRENCES = 465
...
def main():
  ...
  print("=" * 78)
  print(
    "Phase 143-75N full rule-name fallback audit"
  )
  print(
  ...
  if (
    ...
    print(
      "PASS: Phase 143-75M removed exactly "
      "135 fallback occurrences; "
      "465 remain."
    )
  else:
    print(
      "MEASURED RESULT: expected fallback=465 "
