...
class RepositoryGeneratorExplorationPresentation:
  ...
  def _presentations_for_source_occurrences(
    self,
    ...
    return tuple(
      presentation
      for presentation in self.occurrences
      if id(
  ...
  @property
  def toda_bracket_occurrences(
    self,
  ) -> tuple[
    RepositoryGeneratorOccurrencePresentation,
    ...,
  ]:
    return self._presentations_for_source_occurrences(
      self
      .source_result
  ...
  @property
  def group_generator_occurrences(
    self,
  ) -> tuple[
    RepositoryGeneratorOccurrencePresentation,
    ...,
  ...
  @property
  def composition_left_occurrences(
    self,
  ) -> tuple[
    RepositoryGeneratorOccurrencePresentation,
    ...,
  ...
  @property
  def composition_right_occurrences(
    self,
  ) -> tuple[
    RepositoryGeneratorOccurrencePresentation,
    ...,
