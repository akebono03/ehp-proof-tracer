...
backup = path.with_suffix(path.suffix + ".phase143_75al_backup")
...
import_name = "Toda514FirstShortExactStatement"
...
print("Phase 143-75AL semantic renderer patch applied.")
